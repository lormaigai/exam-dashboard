...
Data is stored in browser `localStorage` under `examos-data-v1`. Use Settings to export JSON backups before resetting browser storage or moving devices. The recommendations are rule-based, not AI-generated, and can be adjusted by editing confidence, accuracy, mistakes, assessments, and planner constraints.
